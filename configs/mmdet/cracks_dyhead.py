...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        backend_args=None,
        data_prefix=dict(
            img='/home/titan/DATASET/ai4cracks-dataset/images/test/'),
...
train_dataloader = dict(
    ...
    dataset=dict(
        dataset=dict(
            ...
            backend_args=None,
            data_prefix=dict(
                img='/home/titan/DATASET/ai4cracks-dataset/images/train/'),
            data_root='data/cracks_12_classes/',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        backend_args=None,
        data_prefix=dict(
            img='/home/titan/DATASET/ai4cracks-dataset/images/val/'),
        data_root='/home/theo/workdir/mmdet/data/cracks_12_classes/',
        metainfo=dict(
            classes=(
                'Arrachement_pelade',
...
work_dir = 'outputs/cracks_dyhead_swin_20130801/'
